...
- **同じひとりの「彼女」**：デスクトップ、ゲーム、モバイル、スマートハードウェアをまたいで同じ記憶と人格を共有——一緒に過ごすほど、あなたを分かってくれます。
...
| **AI 酒場（SillyTavern）などのロールプレイ・フロントエンド** | 純テキストの RP フロントエンド：手動で維持するコンテキスト / ワールドブックに依存し、モデルは自分で組み合わせる必要がある | **エンドツーエンドで統合されたプロダクト**：ネイティブな音声 ＋ 視覚、Avatar の動き、シーンをまたぐ永続記憶、時間感覚、そして実際に PC / ブラウザを操作できる——ゼロ設定、箱から出してすぐ使える |
