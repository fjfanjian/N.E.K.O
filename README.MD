...
- **同一个"她"**：跨桌面、游戏、移动端、智能硬件共享同一份记忆与人格，越处越懂你。
...
| **AI 酒馆（SillyTavern）等角色扮演前端** | 纯文字 RP 前端：依赖手动维护上下文 / 世界书，需要自己拼接模型 | **端到端集成的产品**：原生语音 + 视觉、Avatar 动作、跨场景持久记忆、有时间感知、能真正操作电脑 / 浏览器，零配置开箱即用 |
